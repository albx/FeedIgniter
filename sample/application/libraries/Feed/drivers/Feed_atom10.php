...
class Feed_atom10 extends CI_Driver{
	...
	/**
	*	Add the id tag to the atom feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the title tag to the atom feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the subtitle tag to the atom feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the link tag to the atom feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the id updated to the atom feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the author tag to the atom feed
	*	@param array
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the entry tag to the atom feed
	*	@param array
	*	@access public
	*	@return object
	*/
