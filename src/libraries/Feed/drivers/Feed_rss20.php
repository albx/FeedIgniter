...
class Feed_rss20 extends CI_Driver{
	...
	*/
	...
	/**
	*	Add the language tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the copyright tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the managingEditor tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the webMaster tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the pubDate tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the lastBuildDate tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the category tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the generator tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the docs tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the ttl tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the rating tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the skipHours tag to the rss feed
	*	@param array
	*	@access public
	*	@return object
	*/
	...
	/**
	*	Add the skipDays tag to the rss feed
	*	@param string
	*	@access public
	*	@return object
	*/
